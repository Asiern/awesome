...
awful.keyboard.append_global_keybindings({
    ...
    end, { description = "open code editor", group = "apps" }),
    ...
    awful.key({ modkey }, "p", function()
        awful.util.spawn(apps.app_launcher)
    end, { description = "app launcher", group = "apps" })
})

-- Media key bindings
-- DOC: https://wiki.linuxquestions.org/wiki/XF86_keyboard_symbols
awful.keyboard.append_global_keybindings({ -- Brightness controls
    awful.key({}, "XF86MonBrightnessUp", function()
        awful.util.spawn("brightnessctl set +5% -q")
    ...
    awful.key({}, "XF86AudioRaiseVolume", function()
        awful.util.spawn("amixer sset Master 3%+ -q")
...
awful.keyboard.append_global_keybindings({ awful.key({ modkey, ctrl }, "Left", awful.tag.viewprev, {
